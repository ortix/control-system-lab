...
% %% Without implementation of the torque in the system's matrix
...
% linearized_sys = [0 0 1 0; 0 0 0 1; jacobian(theta1ddot_solved,jac_state); jacobian(theta2ddot_solved,jac_state)];
...
% g2 = m2*c2*g;
% 
% theta1 = 0; theta2 = 0; theta1dot =0; theta2dot =0;
% 
...
% A = linearized_sys_solved;
% B = double(subs(inv(M_theta)*T)); B = [0;0;B];
% C = [1 0 0 0; 0 1 0 0];
% D = [0;0]
% 
% syms P1 P2 P3 g1 g2 theta1 theta2 theta1dot theta2dot theta1ddot theta2ddot b1 b2 Torque
...
theta1 = pi; theta2 = 0; theta1dot = 0; theta2dot = 0;
